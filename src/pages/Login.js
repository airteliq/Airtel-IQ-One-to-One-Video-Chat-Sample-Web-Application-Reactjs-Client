            ...
            <div className="container">
                <div className="row d-flex justify-content-center align-items-center">
                    <div className="col-12 col-md-12 col-xl-6 col-lg-6 form-hedding">
                        ...
                        <p>This Sample Code showcases how Airtel IQ Video Service may be used to create a 1-to-1 Video Call
                        Application. The Login Screen explains all basic information is needed to get a Airtel IQ Token to get
                        you connected to a Live Video Session. You may need to create your Access Processes to give a
                    Airtel IQ Token to your User.</p>
                        <h4>Tech Specs</h4>
                        <p>
                            ...
                            <form className="mt-4" id="login_form" onSubmit={enterRoom}>
                                ...
                                <div className="form-row">
                                    <div className="form-group col-md-12">
                                        ...
                                        <label>I
                                    agree to <a target="_blank" rel="noopener noreferrer" href="https://videoiq.airtel.in/developer/legals/tou/">Terms of
                                        Use</a> and
                                        <a target="_blank" rel="noopener noreferrer"
                                                href="https://videoiq.airtel.in/developer/legals/privacy-policy/">Privacy Policy</a>
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div className="row">
                        <div className="col-12 col-md-6">
                            <ul className="footerUl">
                                <li><a href="https://videoiq.airtel.in/developer/legals/tou/">Terms</a></li>
                                <li><a href="https://videoiq.airtel.in/developer/legals/privacy-policy/">Privacy Policy</a></li>
                            </ul>
                        </div>
                        <div className="col-12 col-md-6">
                            <p className="footer-p">Copyright © Airtel IQ . All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </footer>
